...
class MilvusEnumerator<E> implements Enumerator<E> {
    ...
    public MilvusEnumerator(QueryIterator queryIterator, List<String> fieldNames, List<DataType> fieldTypes, MilvusSchema milvusSchema, MilvusServiceClient milvusClient) {
