...
@Generated(
    from = "MilvusFilterTableScanRule",
    generator = "Immutables"
)
final class ImmutableMilvusFilterTableScanRule {
    private ImmutableMilvusFilterTableScanRule() {
    }

    @CheckReturnValue
    @Generated(
        from = "MilvusFilterTableScanRule.Config",
        generator = "Immutables"
    )
    @Immutable
    static final class Config implements MilvusFilterTableScanRule.Config {
        ...
        private Config(RelBuilderFactory relBuilderFactory, @Nullable @org.checkerframework.checker.nullness.qual.Nullable String description, RelRule.OperandTransform operandSupplier) {
            this.initShim = new InitShim();
        ...
        private RelBuilderFactory relBuilderFactoryInitialize() {
            return MilvusFilterTableScanRule.Config.super.relBuilderFactory();
        }

        private RelRule.OperandTransform operandSupplierInitialize() {
            return MilvusFilterTableScanRule.Config.super.operandSupplier();
        }
        ...
        public final Config withDescription(@Nullable @org.checkerframework.checker.nullness.qual.Nullable String value) {
            return Objects.equals(this.description, value) ? this : validate(new Config(this.relBuilderFactory, value, this.operandSupplier));
        }
        ...
        public static Config copyOf(MilvusFilterTableScanRule.Config instance) {
        ...
        public static final class Builder {
            ...
            @CanIgnoreReturnValue
            public final Builder from(MilvusFilterTableScanRule.Config instance) {
                Objects.requireNonNull(instance, "instance");
                this.from((Object)instance);
                return this;
            }
