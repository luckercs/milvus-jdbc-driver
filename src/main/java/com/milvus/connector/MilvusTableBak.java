...
public class MilvusTableBak extends AbstractTable
//        implements TranslatableTable, QueryableTable
{
    private static final Logger LOG = LoggerFactory.getLogger(MilvusTableBak.class);
    ...
    public MilvusTableBak(String databaseName, String collectionName, MilvusSchema milvusSchema) {
